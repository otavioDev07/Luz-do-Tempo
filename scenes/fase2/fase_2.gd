...
func _on_botao_vela_pressed():
	...
	# Exemplo: se o Fogao tem um nó de áudio filho chamado "AudioStreamPlayer"
	


func _on_botao_lampada_mouse_entered() -> void:
	$BotaoLampada/AudioLampada.play()


func _on_botao_vela_mouse_entered() -> void:
	$BotaoVela/AudioVela.play()
