...
# Caminhos corrigidos para a Fase 2.4
var fundo_acerto_img = preload("res://sprites/telas/rua_poste.png")
var fundo_erro_img = preload("res://sprites/telas/rua_lampiao.png")
...
func _on_botao_celular_pressed():
	...
	get_tree().change_scene_to_file("res://scenes/menu/fase_2_completado.tscn")
...
func _on_botao_telefone_mouse_entered() -> void:
	$BotaoTelefone/AudioTelefone.play()
